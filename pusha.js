...
client.ownerst = ["619126609756160000"]; // KURUCU
client.evulate = []
...
client.botAccounts = ["682116946489114635","882795954711965746","882796712769486920","887729477357010944","882791157812310046","882791342621724752","882791554736087081","887729541596999811","758965145166282773","692122007449632818","783186240883130418","801483874051817523","801483981249970206","802530996335280178","848657463033069590","783185168965304330","883355938587828275"], // Güvenli bot ID
client.botroles = ["682116946489114635","882795954711965746","882796712769486920","887729477357010944","882791157812310046","882791342621724752","882791554736087081","887729541596999811","758965145166282773","692122007449632818","783186240883130418","801483874051817523","801483981249970206","802530996335280178","848657463033069590","783185168965304330","883355938587828275"] // YLER GİDİNCE YETKİSİ GİTMİYECEK BOTLARIN ID
let kanal = "882772747443396699" // LOG KANAL
let ustKanal = "883055248900513803" // YETKİSİ YETMEYİNCE BLABLA

client.on("ready", () => {
    client.user.setActivity("VANESSA ❤️ SHELBY");
...
client.on("guildUpdate", async (oldGuild, newGuild) => {
    await newGuild.fetchAuditLogs({
        ...
        if (oldGuild.name !== newGuild.name) {
            newGuild.setName("✰ R E D E N I A ")
...
client.on("message", async message => {
    ...
    if (message.author.id !== "619126609756160000") return
